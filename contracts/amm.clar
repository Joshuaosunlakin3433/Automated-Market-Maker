...
(define-constant FEES_DENOM u1000) ;; fees denominator
...
;; To ensure that the token-0 principal is "less than" the token-1 principal
...
(define-public (create-pool
    ...
    (let (
            ...
            (pool-data {
                ...
                balance-0: u0, ;; initially, balance is 0
                balance-1: u1, ;; initially, balance is 0
            })
        )
...
(define-public (swap (token-0 <ft-trait>) (token-1 <ft-trait>) (fee uint) (input-amount-0 uint) (zero-for-one bool)))